...
public class ModItems {
    ...
    public static final RegistryObject<Item> DIAMOND_SNIPER = ITEMS.register("diamond_sniper", () -> new AbstractGun(0, 1.6, 24, 10).projectileSpeed(4).fireSound(() -> ModSounds.SNIPER.get()));
